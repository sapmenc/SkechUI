'use client'; //tomake a client component if we don't use this nextjs will treat this as a server component by default
            ...
            onSubmit={handleSubmit(handleSignIn)}
                ...
                <div className="bg-card -m-px rounded-[calc(var(--radius)+.125rem)] border p-8 pb-6">
                    <div className="text-center">
                        ...
                        <h1 className="mb-1 mt-4 text-xl font-semibold">Sign In to SketchUI</h1>
