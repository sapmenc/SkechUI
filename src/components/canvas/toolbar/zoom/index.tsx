...
const ZoomBar = () => {
  const dispatch=useDispatch()
    ...
    //get the viewport from the useInfinity hook
    const handleZoomOut=()=>{
  ...
  return (
    <div className='col-span-1 flex justify-end items-center'>
       <div className='flex item gap-1 backdrop-blur-xl bg-white/8 border border-white/12 rounded-full p-3 saturate-150'>
         <Button
         variant="ghost"
         size="lg"
...
//add the zooomin - zoomout feature
